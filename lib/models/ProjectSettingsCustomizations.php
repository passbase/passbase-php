...
class ProjectSettingsCustomizations implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ProjectSettings_customizations';
...
'font_family' => 'getFontFamily'    ];
     ...
     * Sets button_color
     *
     * @param string $button_color \\\"Verify Me\\\" button background color
     *
     * @return $this
     */
     ...
     * Sets accent_color
     *
     * @param string $accent_color Accent color during the verification flow (button, breadcrumb, etc…)
     *
     * @return $this
     */
     ...
     * Sets font_family
     *
     * @param string $font_family Font used in the verification flow
     *
     * @return $this
     */
