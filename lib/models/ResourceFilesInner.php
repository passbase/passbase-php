...
/**
 * ResourceFilesInner Class Doc Comment
 *
 * @category Class
 * @package  Passbase
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class ResourceFilesInner implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'ResourceFiles_inner';
...
'updated' => 'getUpdated'    ];
    ...
    const TYPE_FACE_VIDEO = 'face_video';
const TYPE_DOCUMENT_IMAGE = 'document_image';
    ...
    {
        return [
            self::TYPE_FACE_VIDEO,
self::TYPE_DOCUMENT_IMAGE,        ];
    }
     ...
     * Sets id
     *
     * @param string $id Unique ID representing a resource file
     *
     * @return $this
     */
     ...
     * Sets page
     *
     * @param int $page Page number of the document. Generally 1 would represent the front of a document, and 2 might represent the back of the same document.
     *
     * @return $this
     */
