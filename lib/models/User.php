...
'required_steps' => 'getRequiredSteps'    ];
     ...
     * Sets email
     *
     * @param string $email Email with which the user was created
     *
     * @return $this
     */
     ...
     *
     * @param string $identity_access_token Access token in the shape of a JsonWebToken used as a Bearer token when submitting identity data
     *
     * @return $this
     */
     ...
     * Sets required_steps
     *
     * @param \Passbase\Models\ProjectSettingsVerificationSteps[] $required_steps List of the steps through which the user must go through to complete their verification
     *
     * @return $this
     */
